...
<table border=0><tr>
	...
	<td nowrap>
	&nbsp;&nbsp;&nbsp;&nbsp;<a target=_blank href=print_bugs.aspx>печать списка</a>
	<td  nowrap>
	&nbsp;&nbsp;&nbsp;&nbsp;<a target=_blank href=print_bugs2.aspx>печать детализации</a>
	<td  nowrap>
	&nbsp;&nbsp;&nbsp;&nbsp;<a target=_blank href=print_bugs.aspx?format=excel>экспорт в excel</a>
	<td  nowrap align=right width=100%>
	<a target=_blank href=btnet_screen_capture.exe><img src=camera.png border=0 align=top>&nbsp;скачать утилиту дл€ сн€ти€ скриншотов</a>
</table>
<br>
<%
if (dv != null)
