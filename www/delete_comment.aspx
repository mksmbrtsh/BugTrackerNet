...
void Page_Load(Object sender, EventArgs e)
{
	...
	else
	{
		...
		confirm_href.InnerText = "подтверждение удаления комментария: "
				+ s.Substring(0,len)
				+ "...";
...
<div class=align>
<p>&nbsp</p>
<a id="back_href" runat="server" href="">вернуться к <% Response.Write(Util.get_setting("SingularBugLabel","bug")); %></a>
