...
void Page_Load(Object sender, EventArgs e)
{
	...
	else
	{
		...
		if ((int) dr["cnt"] > 0)
		{
			Response.Write ("¬ы не можете удалить организацию \""
				+ Convert.ToString(dr["og_name"])
				+ "\" потому что некоторые записи, пользователи, запросы ещЄ ссылаютс€ на неЄ.");
			Response.End();
		}
		else
		{
			confirm_href.InnerText = "подтверждение удалени€: \""
				+ Convert.ToString(dr["og_name"])
				+ "\"";
...
<div class=align>
<p>&nbsp</p>
<a href=orgs.aspx>обратно к организаци€м</a>
