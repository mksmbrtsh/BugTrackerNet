...
function my_confirm()
{
	return confirm('Вы не сохранили изменения. Всеравно покинуть страницу?')
}
...
function toggle_images2(bugid)
{
	...
	{
		images_inline = "0"
		set_text(get_el("hideshow_images"), "показывать встроенные изображения")
	}
	else
	{
		images_inline = "1"
		set_text(get_el("hideshow_images"),"скрывать встроенные изображения")
	}
...
function toggle_history2(bugid)
{
	...
	{
		history_inline = "0"
		set_text(get_el("hideshow_history"), "показать историю изменений")
	}
	else
	{
		history_inline = "1"
		set_text(get_el("hideshow_history"), "скрыть историю изменений")
	}
