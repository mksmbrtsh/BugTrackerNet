...
<div class='align'>
<a href='reports.aspx'>Обратно к отчетам</a>
<br><br>
<table border='0'>
	<tr>
		<td>
			<form class='frm' runat="server">
				<table border='0'>
					<tr>
						<td class='lbl'>Заголовок:</td>
						<td><input runat="server" type='text' class='txt' id="desc" maxlength='80' size='80'></td>
						<td runat="server" class='err' id="desc_err">&nbsp;</td>
					</tr>
					<tr>
						<td class='lbl'>Тип диаграммы:</td>
						<td>
							<asp:RadioButton text="Таблица" runat="server" GroupName="chart_type" id="table" />
							&nbsp;&nbsp;&nbsp;
							<asp:RadioButton text="Круговая" runat="server" GroupName="chart_type" id="pie" />
							&nbsp;&nbsp;&nbsp;
							<asp:RadioButton text="Столбцы" runat="server" GroupName="chart_type" id="bar" />
							&nbsp;&nbsp;&nbsp;
							<asp:RadioButton text="График" runat="server" GroupName="chart_type" id="line" />
							&nbsp;&nbsp;&nbsp;
						</td>
