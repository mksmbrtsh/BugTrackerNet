...
<a href=edit_bug.aspx><img src=add.png border=0 align=top>&nbsp;Добавить</a>
<% } %>

<a style='margin-left: 40px;' href='javascript:showhide_form()' id='showhide'>скрыть</a>
...
<table border=0 cellpadding=6 cellspacing=0>
	<tr>
		<td colspan="10"><span class=smallnote>Удерживайте нажатой клавишу Ctrl для выбора нескольких позиций</span></td>
	</tr>

	<tr>
		<td nowrap><span class=lbl>создано:</span><br>
		<asp:ListBox Rows=6 SelectionMode="Multiple" id="reported_by" runat="server" onchange="on_change()">
		</asp:ListBox>
		</td>

		<td nowrap><span class=lbl id="category_label" runat="server">категория:</span><br>
		<asp:ListBox Rows=6 SelectionMode="Multiple" id="category" runat="server" onchange="on_change()">
		</asp:ListBox>
		</td>

		<td nowrap><span class=lbl id="priority_label" runat="server">приоритет:</span><br>
		<asp:ListBox Rows=6 SelectionMode="Multiple" id="priority" runat="server" onchange="on_change()">
		</asp:ListBox>
		</td>

		<td nowrap><span class=lbl id="assigned_to_label" runat="server">ассоциировано с:</span><br>
		<asp:ListBox Rows=6 SelectionMode="Multiple" id="assigned_to" runat="server" onchange="on_change()">
		</asp:ListBox>
		</td>

		<td nowrap><span class=lbl id="status_label" runat="server">статус:</span><br>
...
<table border=0 cellpadding=3 cellspacing=0>
	<tr>
		...
		<td nowrap><span class=lbl id="org_label" runat="server">организация:</span><br>
		<asp:ListBox Rows=6 SelectionMode="Multiple" id="org" runat="server" onchange="on_change()">
		</asp:ListBox>
		</td>

		<td nowrap><span class=lbl id="project_label" runat="server">проект:</span><br>
...
<table border=0 cellpadding=3 cellspacing=0>
	<tr>
		<td><span class=lbl><% Response.Write(Util.capitalize_first_letter(Util.get_setting("SingularBugLabel","bug"))); %> содержит описание:&nbsp;</span>
	...
	<tr>
		<td><span class=lbl><% Response.Write(Util.capitalize_first_letter(Util.get_setting("SingularBugLabel","bug"))); %> комментарий содержит:&nbsp;</span>
	...
	<tr>
		<td nowrap><span class=lbl><% Response.Write(Util.capitalize_first_letter(Util.get_setting("SingularBugLabel","bug"))); %> комментарий начинается с:&nbsp;</span>
	...
	<tr>
		<td nowrap><span class=lbl>Дата создания:&nbsp;</span>
	...
	<tr>
		<td  nowrap><span class=lbl>Дата последнего обновления:&nbsp;</span>
...
%>
	...
	<tr>
		<td colspan=10 nowrap>
			Использовать 'И':<input type="radio" runat="server" name="and_or" value="and" id="and" onchange="on_change()" Checked>
			&nbsp;&nbsp;
			Использовать 'ИЛИ':<input type="radio" runat="server" name="and_or" value="or" id="or" onchange="on_change()">
		</td>
	</tr>
	...
	<tr>
		<td colspan=10 align=center>
			...
			<input class=btn type=submit onclick="set_hit_submit_button()" value="&nbsp;&nbsp;&nbsp;Поиск&nbsp;&nbsp;&nbsp;" runat="server">
		</td>
	</tr>
...
<% } else { %>
			<a href="javascript:on_save_query()">Сохранить поиск как запрос</a>
<% } %>
		</td>
	</tr>
