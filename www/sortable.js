...
function sort_by_col (c, t) {
	document.getElementById("wait").firstChild.nodeValue = "Сортировка. Пожалуйста, подождите...";
	col = c
	type = t
...
function sort_by_col_impl () {
	...
	document.getElementById("sortedby").firstChild.nodeValue = "Отсортировано по "
